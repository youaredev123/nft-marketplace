// Caches Mapbox map accross screens to minimize map initializations
// (basically, save money on Mapbox fees).
// Note that because of this, map state will be the same everywhere by
// default. Extra work may be required to make the map state different on
// different screens.
...
// https://github.com/mapbox/mapbox-gl-js/issues/10173#issuecomment-749060695
// Uglify™ breaks Mapbox™ in release builds, fix it with this:
...
export default function ({ pos, zoom }) {
  if (container === null) {
